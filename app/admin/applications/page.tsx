    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                {/* New Application button - removed until route is implemented */}
            </div>
                ...
                {applications.length > 0 ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <p className="text-gray-400 text-sm mt-1">
                            {status ? `No ${status.replaceAll('_', ' ')} applications` : 'Applications will appear here when clients submit them'}
                        </p>
                    </div>
                )}
            </div>
