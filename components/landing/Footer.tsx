                    ...
                    <div className="mt-8 pt-8 border-t border-white/10">
                        <div className="flex items-center justify-center gap-8 sm:gap-12 py-6 px-4 mx-auto max-w-2xl rounded-2xl bg-[#1B5E3A]/40 border border-[#2D7A4F]/30">
                            ...
                            <div className="flex items-center gap-2 text-white/80" title="Fannie Mae">
                                ...
                                <span className="text-sm font-semibold tracking-wide hidden sm:inline">Fannie Mae</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2 text-white/80" title="Equal Housing Opportunity">
                                ...
                                <div className="hidden sm:block">
                                    <span className="text-sm font-semibold tracking-wide block leading-tight">Equal Housing</span>
                                    <span className="text-[10px] text-white/50 tracking-wider uppercase">Opportunity</span>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 text-white/80" title="Freddie Mac">
                                ...
                                <span className="text-sm font-semibold tracking-wide hidden sm:inline">Freddie Mac</span>
                            </div>
                        </div>
                    </div>
